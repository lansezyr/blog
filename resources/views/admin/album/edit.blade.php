...
@section('content')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('admin/article')}}">{!! trans('labels.breadcrumb.albumList') !!}</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <span>{!! trans('labels.breadcrumb.albumEdit') !!}</span>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.albumEdit') !!}</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    ...
                    @endif
                    <form role="form" class="form-horizontal" method="POST" action="{{url('admin/album/'.$album->id)}}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="{{trans('labels.album.name')}}" value="{{$album->name}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>

                            <div class="form-group form-md-line-input">
                                <label class="col-md-2 control-label" for="cover">{{trans('labels.album.cover')}}</label>
                                <div class="col-md-8">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="{{$album->cover or asset('backend/img/no-image.png')}}" alt="" /> </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" name="description" rows="5" placeholder="Enter more text">{{$album->description}}</textarea>
                                    <div class="form-control-focus"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" id="status1" name="status" value="{{config('admin.global.status.active')}}" class="md-radiobtn" @if($album->status == config('admin.global.status.active')) checked @endif>
                                            <label for="status1">
                                                <span></span>
                                        ...
                                        <div class="md-radio">
                                            <input type="radio" id="status2" name="status" value="{{config('admin.global.status.audit')}}" class="md-radiobtn" @if($album->status === config('admin.global.status.audit')) checked @endif>
                                            <label for="status2">
                                                <span></span>
                                                <span class="check"></span>
                                        ...
                                        <div class="md-radio">
                                            <input type="radio" id="status3" name="status" value="{{config('admin.global.status.trash')}}" class="md-radiobtn" @if($album->status == config('admin.global.status.trash')) checked @endif>
                                            <label for="status3">
                                                <span></span>
                                                <span class="check"></span>
