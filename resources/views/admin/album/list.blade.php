        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">{!!trans('labels.breadcrumb.albumList')!!}</span>
                </div>
                <div class="actions">
                    <div class="btn-group">
                        @permission(config('admin.permissions.album.create'))
                        <a href="{{url('admin/album/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        ...
                        <tr role="row" class="heading">
                            <th>#</th>
                            <th> {{ trans('labels.album.name') }} </th>
                            <th> {{ trans('labels.album.user_id') }} </th>
                            <th> {{ trans('labels.album.status') }} </th>
                            <th> {{ trans('labels.album.cover') }} </th>
                            <th> {{ trans('labels.album.created_at') }} </th>
                            <th> {{ trans('labels.album.updated_at') }} </th>
                            ...
                            <td>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control form-filter" name="name" placeholder="{{ trans('labels.album.name') }}">
                            ...
                            <td>
                                <div class="form-group form-md-line-input">
                                    <select class="bs-select form-control form-filter" data-show-subtext="true" name="status">
                                        ...
                                        @if(trans('strings.album'))
                                            @foreach(trans('strings.album') as $status_key => $status_value)
...
@section('js')
    ...
    <script type="text/javascript" src="{{asset('backend/js/album/album-list.js')}}"></script>
